...
public class MainActivity extends Activity {
    ...
    TelaCadastroComida tela_cadastro;
    TelaListagemComidas tela_listagem;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tela_cadastro = new TelaCadastroComida(this, tela_principal);
        tela_listagem = new TelaListagemComidas(this, tela_principal);
